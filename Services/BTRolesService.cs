...
namespace TheBugTracker.Services
{
    ...
    public class BTRolesService : IBTRolesService
    {
        ...
        public async Task<bool> AddUserToRoleAsync(BTUser user, string roleName)
        {
            ...
            //.Succeeded indicates whether the operation succeeded or not.
            return result;
        }
        ...
        public async Task<List<BTUser>> GetUsersNotInRoleAsync(string roleName, int companyId)
        {
            ...
            //Once i get the users in this role, select only their Id.
            List<BTUser> roleUsers = _context.Users.Where(u => !userIds.Contains(u.Id)).ToList();
            //for every user record, check to see if its contained in the list of userid's that i found.
        ...
        public async Task<bool> RemoveUserFromRolesRoleAsync(BTUser user, IEnumerable<string> roles)
        {
