...
namespace TheBugTracker.Data
{
    ...
    {
        //static means wthere's only going to be 1
        //instance of this class for the entire application.
        //Company Ids
        ...
        public static async Task SeedDefaultCompaniesAsync(ApplicationDbContext context)
        {
            try
            {
                IList<Company> defaultcompanies = new List<Company>() {
                    new Company() { Name = "EgoShift Technologies", Description="Junior Development: Providing work experience for entry level developers." },
                ...
                //Get company Ids
                company1Id = context.Companies.FirstOrDefault(p => p.Name == "EgoShift Technologies").Id;
            ...
            try
            {
                IList<Project> projects = new List<Project>() {
                     ...
                     new Project()
                     {
                         ...
                         StartDate = new DateTime(2024,8,20),
                         EndDate = new DateTime(2024,8,20).AddMonths(4),
                     ...
                     new Project()
                     {
                         ...
                         StartDate = new DateTime(2024,8,20),
                         EndDate = new DateTime(2024,8,20).AddMonths(6),
                     ...
                     new Project()
                     {
                         ...
                         StartDate = new DateTime(2024,8,20),
                         EndDate = new DateTime(2024,8,20).AddMonths(2),
                         ProjectPriorityId = priorityLow
                     },
                    new Project()
                     {
                         ...
                         StartDate = new DateTime(2024,8,20),
                         EndDate = new DateTime(2024,8,20).AddMonths(3),
                         ProjectPriorityId = priorityHigh
                     }
                };
